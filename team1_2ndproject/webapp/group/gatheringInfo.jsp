<%@ page contentType="text/html;charset=utf-8"
	import="java.util.ArrayList, team1.togather.domain.Gathering"%> 
...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-gray">
		<div class="container px-4 px-lg-5">
			<h1 class="logo">
				<a href="../"><img src="../imgs/topLogo.png"
					alt="ToGather" title="홈으로 이동" /></a>
			</h1>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
					<li class="nav-item"><a class="nav-link active"
						aria-current="page" href="../customer/introduce.jsp">ToGather란?</a></li>
					<li class="nav-item"><a class="nav-link" href="../customer/notice.jsp">공지사항</a>
					</li>
					<li class="nav-item dropdown"><a
						class="nav-link dropdown-toggle" id="navbarDropdown" href="#"
						role="button" data-bs-toggle="dropdown" aria-expanded="false">자주하는
							질문</a>
							...
							<div class="card-body p-md-5">
								<div class="row justify-content-center">
									<div class="col-md-5 col-lg-10 col-xl-6 order-2 order-lg-1">
										<div>
											<img src="../imgs/gathering.jpg" class="img-fluid"
												alt="Sample image" />
										</div>
									</div>
									<div class="col-md-5 col-lg-10 col-xl-6 order-2 order-lg-1">
										...
										<form class="mx-1 mx-md-4">
											<div class="d-flex flex-row align-items-center mb-0">
												...
												<div class="form-outline flex-fill mb-2">
													<label class="form-label mb-0" for="form3Example1c"><i
														class="bi bi-calendar"></i></label> <input type="text"
														class="form-control" value="${gathering.ga_date}" readonly />
												</div>
											</div>
											...
											<div class="d-flex flex-row align-items-center mb-0">
												...
												<div class="form-outline flex-fill mb-2">
													<label class="form-label mb-0" for="form3Example4c"><i
														class="bi bi-clock"></i></label> <input type="text"
														class="form-control" value="${gathering.time}" readonly />
												</div>
											</div>
											...
											<div class="d-flex flex-row align-items-center mb-0">
												...
												<div class="form-outline flex-fill mb-2">
													<label class="form-label mb-0" for="form3Example4c"><i
														class="bi bi-pin-map-fill"></i></label> <input type="text"
														class="form-control" value="${gathering.ga_place}"
														readonly />
												</div>
											</div>
											...
											<div class="d-flex flex-row align-items-center mb-0">
												...
												<div class="form-outline flex-fill mb-2">
													<label class="form-label mb-0" for="form3Example4c"><i
														class="bi bi-cash-coin"></i></label> <input type="text"
														class="form-control" value="${gathering.price}" readonly />
												</div>
											</div>
											...
											<div class="d-flex flex-row align-items-center mb-0">
												...
												<div class="form-outline flex-fill mb-2">
													<label class="form-label mb-0" for="form3Example4c"><i
														class="bi bi-people-fill"></i></label> <input type="text"
														class="form-control" value="${gathering.ga_limit}"
														readonly />
												</div>
											</div>
											<div
