...
public class GatheringPage {
	...
	public GatheringPage(int totalCount, int startPage, int endPage, boolean prev, boolean next, BoardCriteria cri,
			int displayPageNum) {
		super();
	...
	public String toString() {
		return "GatheringPage [totalCount=" + totalCount + ", startPage=" + startPage + ", endPage=" + endPage + ", prev="
