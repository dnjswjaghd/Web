...
<meta charset="utf-8">
  ...
  <body>
     ...
     <hr width="600" color="Maroon" size="2" noshade>
       <font size="5" color="Navy"  align="center"><b>글 쓰 기</b></font>
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <a href="board.do?m=list&userid=${userid }">목록</a>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <a href='../'>메인</a>
     <hr width="600" color="Maroon" size="2" noshade>
      <!-------------------- re 변화 1 ------------------------------->
     <form name="input" action="board.do?m=upload&userid=${userid}" method="post" enctype="multipart/form-data">
 
     <!-------------------------------------------------------------->
       <!-- <input type="hidden"  name="method" value="writeOk"> -->
       <input type="hidden" id="NN" name="userid" value="${userid}">
       <table align="center" width="600" cellspacing="1" 
        ...
        <tr>
         ...
         <td align="center" width="80%">
           <input type="text" name="writer" size="60" value="${userid }">
         </td>
        </tr>
        <tr>
          <td align="center" width="20%">이메일</td>
         <td align="center" width="80%">
           <input type="text" name="email" size="60" value="${userid }">
         </td>
        </tr>
        <tr>
